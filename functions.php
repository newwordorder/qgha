...
function new_theme_scripts() {
	...
	wp_enqueue_script( 'new-theme-navigation', get_template_directory_uri() . '/existingscripts/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'new-theme-skip-link-focus-fix', get_template_directory_uri() . '/existingscripts/skip-link-focus-fix.js', array(), '20151215', true );
